...
---
When Google announced their ChromeOS there was a flurry of comment and opinion on what this could mean for the GNU/Linux user and the future of free software. Our esteemed editor, Tony Mobily made a bold statement (albeit framed as a question) at the time that Google's [ChromeOS could turn GNU/Linux into a "desktop winner"](/articles/why_google_chrome_os_will_turn_gnu_linux_desktop_winner/). I'm not sure that it's true.
