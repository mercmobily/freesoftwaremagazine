...
When pressed on this point, representatives from Creative Commons who I've talked to have made it clear that the Attribution requirement is _not_ an advertisement and that it is limited to simple textual explanations of sources. But of course, even that can be a little tricky when there are many works being combined -- especially when they are not combined in an "even" way so that it is clear (or possibly unclear) who deserves more or less credit in the final derived work. I faced similar issues when deciding how profits should be shared ("Artists Should Be Paid", Parts: [1](/articles/artists_should_be_paid_part_1_why_creator_endorsed_sales_promote_fair_sharing/), [2](/articles/artists_should_be_paid_part_2_whats_fair/), [3](/articles/artists_should_be_paid_part_3_big_picture/)) on my [Lunatics](http://lunatics.tv) project. Probably many of the same ideas would apply. 
